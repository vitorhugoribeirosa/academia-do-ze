...
public sealed class Colaborador : Pessoa, IAggregateRoot
{
    ...
    private Colaborador(int id, string nome, Cpf cpf, DateOnly dataNascimento,
        Telefone telefone, Email email, Endereco endereco, Senha senha, Arquivo foto,
    ...
    public static Result<Colaborador> Criar(int id, string nome, string cpf,
        DateOnly dataNascimento, string telefone, string email, Logradouro endereco,
        ...
        DateOnly dataAdmissao, ColaboradorTipo tipo, ColaboradorVinculo vinculo)
    {
        ...
        return Result<Colaborador>.Success(new Colaborador(id, nome, cpfResult.Value!,
            dataNascimento, telefoneResult.Value!, emailResult.Value!,
